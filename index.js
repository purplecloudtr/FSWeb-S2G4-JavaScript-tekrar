...
/* 	GÖREV 3:
    ...
    sayilar dizisi içerisinde birden fazla kez yazılmış sayıları tespit ederek kaç kere tekrar edildiğini belirten bir 
    string oluşturulup `tekraredensayilar` dizisine aktarılmasını istiyoruz. Örnek string: "{sayı} sayısı {tekrarSayisi} 
...
const ucebolunenlerintoplami = ucetambolunenler.reduce((sum, sayi) => {		
 return sum + sayi;		
}, 0);		
